...
CMD ["node", "server.js"]`,
  ...
  },
  {
    ...
    items: [
      {
        title: "Git: clean up merged branches",
        typeId: "system-command",
        contentType: "text" as const,
        language: "bash",
        description: "Delete all local branches already merged into main",
      ...
      {
        title: "Docker: remove stopped containers and dangling images",
        typeId: "system-command",
        contentType: "text" as const,
        language: "bash",
        description: "Prune stopped containers, dangling images, and unused networks",
        content: `docker system prune -f && docker image prune -f`,
        tags: ["docker", "terminal", "cleanup"],
        isFavorite: false,
        isPinned: false,
      },
      {
        ...
        contentType: "text" as const,
        language: "bash",
        description: "Kill whatever is listening on a given port (default 3000)",
        content: `lsof -ti tcp:3000 | xargs kill -9`,
        tags: ["terminal", "process", "networking"],
        isFavorite: false,
        isPinned: false,
      },
      {
        ...
        contentType: "text" as const,
        language: "bash",
        description: "Show all packages with available updates",
    ...
    items: [
      {
        ...
        contentType: "url" as const,
        language: null,
        description: "Official Tailwind CSS v4 utility-first framework docs",
        content: null,
      ...
      },
      {
        ...
        contentType: "url" as const,
        language: null,
        description: "Beautifully designed, accessible React components",
        content: null,
      ...
      },
      {
        ...
        contentType: "url" as const,
        language: null,
        description: "Unstyled, accessible primitives for building React design systems",
        content: null,
      ...
      },
      {
        ...
        contentType: "url" as const,
        language: null,
        description: "Open-source icon library – searchable, copy-paste ready",
        content: null,
