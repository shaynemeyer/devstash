...
import { CODE_EDITOR_BG, CODE_EDITOR_TITLEBAR_BG } from "./constants"
  ...
  return (
    <section className="py-24 px-6 bg-card/50">
      <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <ul className="flex flex-col gap-3">
            {CHECKLIST.map((item) => (
              <li key={item} className="flex items-start gap-3 text-sm">
                <span className="w-5 h-5 rounded-full flex items-center justify-center shrink-0 mt-0.5 text-green-400 text-[0.6rem] bg-green-500/20 border border-green-500/40">
                  ✓
                </span>
                {item}
              </li>
        ...
        {/* Code editor mockup */}
        <FadeIn>
          <div className="rounded-2xl overflow-hidden border border-border font-mono text-sm" style={{ background: CODE_EDITOR_BG }}>
            {/* Editor titlebar */}
            <div className="flex items-center gap-2 px-4 py-3 border-b border-border" style={{ background: CODE_EDITOR_TITLEBAR_BG }}>
            ...
            {/* AI tags */}
            <div className="flex flex-wrap items-center gap-2 px-5 py-3 border-t border-border" style={{ background: CODE_EDITOR_TITLEBAR_BG }}>
