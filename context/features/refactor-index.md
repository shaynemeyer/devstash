...
Track status of all planned refactors. Update when each is completed.

| Refactor | File | Lines | Status |
|---|---|---|---|
| [ItemDrawer](refactor-item-drawer.md) | `src/components/items/ItemDrawer.tsx` | 619 | Completed |
